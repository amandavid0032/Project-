 ...
 *   https://datatables.net/download/#bs5/dt-1.11.5/sb-1.3.2/sp-2.0.0
 *
 * Included libraries:
 *   DataTables 1.11.5, SearchBuilder 1.3.2, SearchPanes 2.0.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.models.oSearch = {
		...
		DataTable.ext = _ext = {
			 ...
			 *  @type string
			 */
			build:"bs5/dt-1.11.5/sb-1.3.2/sp-2.0.0",
