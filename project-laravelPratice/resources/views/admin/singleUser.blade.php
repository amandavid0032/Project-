                                        ...
                                        <div class="p-5">
                                                ...
                                                <div class="form-group">
                                                    @foreach ($data as $id => $row)
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <img src='http://localhost/php-Pratice/twig/uploads/{{ img }}'
                                                                alt='User Image' width='50' class="ml-2">
                                                            {% endfor %}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-check-input" type="radio" name="gender"
                                                    name="male" id="male" value="male" checked>
                                                {% else %}
                                                <input class="form-check-input" type="radio" name="gender"
                                                ...
                                                <input class="form-check-input" type="radio" name="gender"
                                                    name="female" id="female" value="female" checked>
                                                {% else %}
                                                <input class="form-check-input" type="radio" name="gender"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="role" name="role">
                                                    <option value="0" {% if row.type == '0' %} selected
                                                        {% endif %}>
                                                        User
                                                    </option>
                                                    <option value="1" {% if row.type == '1' %} selected
                                                        {% endif %}>
                                                        Admin
                                                    </option>
                                                </select>
